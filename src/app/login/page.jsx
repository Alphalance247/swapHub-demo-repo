    ...
    return (
        ...
        <section className="bg-[#F5F5F5] rounded-[40px] flex items-start flex-col px-[120px] pt-10 pb-[100px] w-[1440px] gap-16">
            ...
            <div className="flex items-center gap-[5.714]">
                ...
                height={34.286}
                 />
                 <p className="text-[#000] font-[Recoleta] font-bold text-center not-italic">swaphub</p>
            </div>
           
            <section className=" flex items-center gap-16">
                <div>
                     <BgImage className="flex-1 self-stretch rounded-2xl "
                ...
                <div className="bg-[#FFF] flex flex-col justify-center items-center p-10 gap-10 w-[488px] rounded-2xl">
                    <div className="flex flex-col items-start self-stretch gap-2">
                         <h1 className="text-[#303030] self-stretch font-bold font-[Recoleta] text-2xl not-italic">Welcome Back to Swaphub!</h1>
                        <p className="text-[#B5B5B5] self-stretch font-[Inter] text-base font-[450px] not-italic">Access your dashboard, manage your products & services, and connect with customers.</p>
                    </div>
                        ...
                        <div className="flex flex-col items-center self-stretch gap-6">
                            <div className="flex justify-center items-center px-3 py-2 bg-[#F1F1F1] rounded-3xl w-[200px] gap-2.5">
                                <Icon
                                    ...
                                    height={20}
                                />
                                <p className=" text-[#303030] font-[Inter] w-[450px] text-sm not-italic">Log In with Google</p> 
                            </div>
                            <div className="flex justify-center items-center gap-4 self-stretch">
                                <hr className="h-[1px] w-[174.5px] text-[#B5B5B5]"/>
                                 <p className="font-[Inter] not-italic font-[450px] text-[16px] leading-4">Or</p>  <hr className="h-1 w-44" />
                            </div>
                         </div>
                       
                        <form action="" >
                            <div className="flex w-[400px] flex-col items-start">
                                <label className="font-[Inter] font-[450px] text-[16px] leading-5 text-[#303030]">Email Address</label>
                                <input className="flex items-center self-stretch p-3 border-[0.5px] border-solid border-[#8A8A8A]" typeof="email" placeholder="Enter your email adddress"  />
                            </div>
                            <div className="flex w-[400px] flex-col items-start">
                                <label className="font-[Inter] font-[450px] text-[16px] leading-5 text-[#303030]">Password</label>
                                <input className="flex items-center self-stretch p-3 border-[0.5px] border-solid border-[#8A8A8A]" typeof="password" placeholder="Enter your password" />
                            </div>
                            <div className="flex items-center self-stretch justify-center py-3 px-4 gap-[10px] rounded-md bg-[#121212] border-[1px] border-solid border-[#121212]">
                                <button typeof="submit" className="text-[#FFF] text-center font-[Inter] text-[16px] leading-5 font-medium not-italic">Create account</button>
                            </div>
                        </form>
                        <p className="self-stretch font-[Inter] font-[450px] text-sm ">Don't have an account? <a className="text-[#005BD3] decoration-solid decoration-auto underline underline-offset-auto " href="#">Sign up for free</a></p>
                    </div>
